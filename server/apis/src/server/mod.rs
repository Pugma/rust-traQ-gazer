...
where
    ...
    A: apis::similar::Similar + apis::stamps::Stamps + apis::trend::Trend + apis::words::Words + 'static,
{
...
fn words_user_id_get_validation(
  ...
  models::WordsUserIdGetPathParams,
), ValidationErrors>
{
  path_params.validate()?;
    ...
    A: apis::words::Words,
{
  ...
  let result = api_impl.as_ref().words_user_id_get(
      method,
      host,
      cookies,
        path_params,
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::words::WordsUserIdGetResponse::Status200_SuccessfulRetrieval
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
