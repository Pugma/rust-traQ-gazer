...
pub trait Trend<E: std::fmt::Debug + Send + Sync + 'static = ()>: super::ErrorHandler<E> {
    /// 今日のトレンド.
    ///
    ...
    ) -> Result<GetTodayTrendingWordsResponse, E>;
    ...
    ) -> Result<GetTrendingWordsForDayResponse, E>;
    ...
    ) -> Result<GetTrendingWordsForMonthResponse, E>;
    ...
    ) -> Result<GetTrendingWordsForYearResponse, E>;
}
